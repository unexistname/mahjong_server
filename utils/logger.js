...
const admin = log4js.getLogger('admin');
...
exports.error_log = function (...args) {
    let str = arg2str(args);
    log(str,styles.redBG);
    error.error(str);
}
exports.center_log = function (...args) {
    let str = arg2str(args);
    log(str,styles.cyan);
    center.info(str);
}
exports.login_log = function (...args) {
    let str = arg2str(args);
    log(str,styles.green);
    login.info(str);
}
exports.hall_log = function (...args) {
    let str = arg2str(args);
    log(str,styles.magenta);
    hall.info(str);
}
exports.admin_log = function (...args) {
    let str = arg2str(args);
    log(str,styles.blue);
    admin.info(str)
}
exports.game_log = function (...args) {
    let str = arg2str(args);
    log(str,styles.yellow);
    game.info(str)
}
exports.key_log = function (...args) {
    let str = arg2str(args);
