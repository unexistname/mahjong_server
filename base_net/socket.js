...
const stream = require('../base_net/binstream');
...
exports.req = {
    ...
    perspective              : 200,
    replace_card_get         : 201,
    replace_card_set         : 202,
    ...
    combine_card_finish         : 500,
    use_special_card            : 501,
};
...
exports.resp = {
    ...
    dx_turn_betting_notify        : 130,
    zjh_turn_betting_notify       : 140,
    turn_betting_notify      : 160,
    ...
    replace_card_get         : 201,
    replace_card_set         : 202,
    update_permission        : 203,
    
    betting_call_notify            : 301,
    betting_raise_notify            : 302,
    betting_waive_notify            : 303,
    betting_watch_notify            : 304,
    betting_compare_notify            : 305,
    eliminate_notify                : 306,

    dizhu_cost                      : 400,
    combine_card                    : 500,
    combine_card_result             : 502,
    game_common_holds               : 601,
